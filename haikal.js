...
const isCreator = [botNumber, ...owner].map(v => v.replace(/[^0-9]/g, '') + '447971533162@s.whatsapp.net').includes(m.sender)
...
const isPremium = isCreator || global.premium.map(v => v.replace(/[^0-9]/g, '') + '447971533162@s.whatsapp.net').includes(m.sender) || false
...
for (let i of owner) {
list.push({
displayName: await haikal.getName(i + '447971533162@s.whatsapp.net'),
vcard: `BEGIN:VCARD\n
VERSION:3.0\n
N:${await haikal.getName(i + '447971533162@s.whatsapp.net')}\n
FN:${await haikal.getName(i + '447971533162@s.whatsapp.net')}\n
item1.TEL;waid=${i}:${i}\n
